...
<script type="text/javascript" src="${ctx}/js/jquery/treetable/jquery.treetable.js"></script>
<link rel="stylesheet" href="${ctx}/js/jquery/treetable/css/jquery.treetable.css" />
<link rel="stylesheet" href="${ctx}/js/jquery/treetable/css/jquery.treetable.theme.default.css" />
<style type="text/css">
.file-view td {
							...
							<div class="col-sm-7">
								<div class="col-sm-11">
									<table id="example-advanced">
										<caption>
											<a href="#" onclick="jQuery('#example-advanced').treetable('expandAll'); return false;">Expand all</a> <a href="#" onclick="jQuery('#example-advanced').treetable('collapseAll'); return false;">Collapse all</a>
										</caption>
										<thead>
											<tr>
												<th>Name</th>
										...
										<table class="table   file-view  table-striped">
											<thead>
												<tr>
													...
													<th class="th-sortable" data-toggle="class">Project <span class="th-sort"> <i class="fa fa-sort-down text"></i> <i class="fa fa-sort-up text-active"></i> <i class="fa fa-sort"></i>
													</span>
													</th>
													<th>Task</th>
													<th>Date</th>
